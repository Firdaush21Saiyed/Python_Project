...
**STEP BY STEP PROJECT HOW IT WORK**
   ...
   1. Overview of Global Video Game Sales :

   2. DATA CLEANING :

   3. Exploratory Data Analysis (EDA) :

         1. Genre Analysis: Highest Critic Score and Global Market Performance.
         2. Highest Global Selling Video Game.
         3.  3.1 Peak Sales Year Analysis.
             3.2 Industry Growth Trend Evaluation.
         4. Genre Distribution Across Gaming Platforms.
         5. Games with Contrasting Popularity by Region
